...
const assignHostname = inputParser.assign(
  parsely.matchValue('hostname'),
  hostnames
);
...
const statusInputToQsParser = fp.flow(tokenizer, statusParser, x => x.result);

describe('the input to qs parser', () => {
  const inputOutput = {
    '': '',
    a: new Error(
      'Expected one of in, contains, starts with, ends with, =, >=, <=, >, < got end of string'
    ),
    'a = ': new Error(
      'Expected one of value, four digit year got end of string'
    ),
    'a b': new Error(
      'Expected one of in, contains, starts with, ends with, =, >=, <=, >, < got b at character 2'
    ),
    'a = [1,2,3]': new Error(
      'Expected one of value, four digit year got [ at character 4'
    ),
    ...
    'a > 201-10-10 10:20:23': new Error(
      'Expected four digit year got 201 at character 4'
    ),
    'a < 2016-13-10 10:20:23': new Error(
      'Expected two digit month between 1 and 12 got 13 at character 9'
    ),
    'a <= 2016-12-32 10:20:23': new Error(
      'Expected two digit day between 1 and 31 got 32 at character 13'
    ),
    'a >= 2016-12-31 24:20:23': new Error(
      'Expected two digit hour between 1 and 23 got 24 at character 16'
    ),
    'a = 2016-12-31 23:60:23': new Error(
      'Expected two digit minute between 00 and 59 got 60 at character 18'
    ),
    'a <= 2016-12-31 23:59:60': new Error(
