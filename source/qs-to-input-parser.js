...
export const inToken: tokensToResult = parsely.parseStr([parsely.tokenTo('__in', ' in '), equalsEmpty]);
export const orderBy: tokensToResult = parsely.parseStr([parsely.tokenTo('order_by', ' order by '), equalsEmpty]);

export const gte: tokensToResult = parsely.parseStr([parsely.tokenTo('__gte', ' >= '), equalsEmpty]);
export const lte: tokensToResult = parsely.parseStr([parsely.tokenTo('__lte', ' <= '), equalsEmpty]);
export const lt: tokensToResult = parsely.parseStr([parsely.tokenTo('__lt', ' < '), equalsEmpty]);
export const gt: tokensToResult = parsely.parseStr([parsely.tokenTo('__gt', ' > '), equalsEmpty]);

export const assign = (l: tokensToResult, r: tokensToResult) => parsely.parseStr([l, equals, r]);

export const like = (l: tokensToResult, r: tokensToResult) => parsely.parseStr([l, contains, equalsEmpty, r]);

export const starts = (l: tokensToResult, r: tokensToResult) => parsely.parseStr([l, startsWith, equalsEmpty, r]);

export const ends = (l: tokensToResult, r: tokensToResult) => parsely.parseStr([l, endsWith, equalsEmpty, r]);

export const inList = (l: tokensToResult, r: tokensToResult) => parsely.parseStr([l, inToken, valueSep(r)]);
