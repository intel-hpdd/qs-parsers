...
if (process.env.RUNNER === 'CI') {
  ...
  var junitReporter = jasmineJUnitReporter({
    ...
    JUnitReportFilePrefix: process.env.FILE_PREFIX || 'qs-parsers-results-' +  process.version,
    JUnitReportSuiteName: 'Qs Parsers Reports',
    JUnitReportPackageName: 'Qs Parsers Reports'
  });
